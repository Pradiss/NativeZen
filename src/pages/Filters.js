    ...
    return(
        <View>
            <View>
                ...
                <TextInput style={styles.input}  value={instrumento} onChangeText={setInstrumento} placeholder="Coloque o instrumento" keyboardType="default"/>
                ...
                <TextInput value={precoMax} onChangeText={setPrecoMax} placeholder="Coloque o preco maximo" keyboardType="numeric"/>
                <TextInput value={precoMin} onChangeText={setPrecoMin} placeholder="Coloque o preco minimo" keyboardType="numeric"/>
                
            </View>
            <Pressable onPress={() => navigation.navigate("MainTabs", {screen: "Explore"})}><Text>Filtrar</Text></Pressable>
        </View>
    )
