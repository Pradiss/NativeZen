  ...
  const Register = async () => {
    ...
    try {
      const dataToSend = {
        ...
        preco: Number(formData.preco.replace(/\D/g, "")) || 0, 
    ...
    switch (step) {
      case 1:
        if (
          ...
          !formData.idade.trim() ||
          !formData.preco.trim() ||
          !formData.idCategoria.trim() ||
          !formData.idInstrumento.trim()
        ) {
          Alert.alert(
            "Campos Obrigatórios",
            "Preencha o seu Nome, idade, Instrumento, Estilo Musical e o seu Preço "
          );
          return;
        }
        break;
      ...
      case 2:
        if (
          ...
          Alert.alert(
            "Campos obrigatórios",
            "Preencha o CEP sua cidade e o Estado "
          );
          return;
        }
        break;
        ...
        return (
          <>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                updateField("preco", formatReaisInteiro(text))
              }
              keyboardType="numeric"
              maxLength={12}
        ...
        return (
          <>
            <TextInput
              ...
              onChangeText={(text) =>
                updateField("whatsapp", formatPhone(text))
              }
            />
            <TextInput
              style={styles.inputLogin}
          ...
          <>
            <View style={{ paddingBlock: 8, paddingBottom: 12 }}>
              ...
              <Text style={styles.textRegister}>
                Preço:{" "}
                <Text style={{ color: "#6BD2D7", fontWeight: 400 }}>
                  {formData.preco ? formData.preco : "R$ 0"}
                </Text>
              </Text>
      ...
      <SafeAreaView>
        ...
        {step === 1 && (
          <View style={{ marginBlock: 16 }}>
            ...
            >
              Nos conte o básico sobre você e sua arte. Esse é o primeiro passo
              para estar visível no app!
            </Text>
          </View>
        )}
        ...
        {step === 2 && (
          <View style={{ marginBlock: 16 }}>
            ...
            >
              Essas informações ajudam quem está procurando músicos como você na
              sua região.
            </Text>
          </View>
        )}
        ...
        {step === 4 && (
          <View style={{ marginBlock: 16 }}>
            ...
            >
              Cadastre seu e-mail e senha para entrar no app sempre que quiser
              atualizar seu perfil ou responder pedidos.
            </Text>
          </View>
        )}
